...
This workflow runs on Windows. Worker counts should be adjusted conservatively on Windows systems, as aggressive multiprocessing settings can cause instability on consumer hardware.
---
